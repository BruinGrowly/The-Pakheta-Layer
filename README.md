...
DIVINE SOURCE (1,1,1,1)
   ↓
MEANING / SEMANTICS (Primal Content)
   ↓
...
MATHEMATICS (Description & Curvature)
   ↓
PHYSICS (Spacetime & Interaction)
   ↓
MATTER (Observed Physical Nodes)
```
...
* [cosmological_bridges_results.json](./experiments/cosmological_bridges_results.json) — Output results of the cosmological Hierarchy Scale sweep.
